...
class Generate extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {arrowClass: "angle right icon", formIsHidden: {display: "none"}};
  }


  changeArrowClass = () => {
    if(this.state.arrowClass == "angle right icon"){
      this.setState({arrowClass: "angle down icon", formIsHidden: {display: "block"}});
      
    }
    else{
      this.setState({arrowClass: "angle right icon", formIsHidden: {display: "none"}});
    }
  }
...
<div className="ui center aligned text container">
          <h1 className="ui huge header">Generate a Logo</h1>
          <p className="lead">
          ...
          <a class="ui horizontal label" onClick={this.changeArrowClass} style={{marginBottom: "1em"}}><i class={this.state.arrowClass} style={{marginLeft: "2px", fontSize: "1em"}} >
    
  </i>Generation Options</a>
<form class="ui form" style={this.state.formIsHidden}>
  ...
  <div class="two fields">
    <div class="field">
      <label>State</label>
      <select class="ui fluid dropdown" style={this.state.formIsHidden}>
  ...
  <div class="fields">
    ...
    <div class="six wide field">
      ...
      <div class="two fields" >
        <div class="field">
          <select class="ui fluid search dropdown" name="card[expire-month]" style={this.state.formIsHidden}>
  ...
  {/*<div class="ui button" tabindex="0" style={{display: "block"}}>Submit Order</div>*/}
</form>
<br/>
<div class="ui button center primary" tabindex="0">Generate Logo</div>
</div>


        
        <div className="ui" style={{ marginTop: "2em" }}>
          <img
